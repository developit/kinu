export default [
  ...
  },
  {
    ...
    description: 'Comprehensive guide to building accessible applications with PUI'
  },
  {
    slug: 'performance',
    title: 'Performance',
  ...
  },
  {
    ...
    category: 'Examples',
    order: 1,
    file: 'pages/recipes.md',
    description: 'Production-ready patterns and examples for common UI features'
  },
  {
    slug: 'login-form',
    title: 'Login Form',
    ...
    category: 'Recipes',
    order: 2,
    file: 'pages/recipes/login-form.md',
  ...
  },
  {
    ...
    category: 'Recipes',
    order: 3,
    file: 'pages/recipes/multi-step-wizard.md',
  ...
  },
  {
    ...
    category: 'Recipes',
    order: 4,
    file: 'pages/recipes/data-table.md',
  ...
  },
  {
    ...
    category: 'Recipes',
    order: 5,
    file: 'pages/recipes/command-palette.md',
    description: 'Keyboard-first command palette with fuzzy search'
  },
  {
    slug: 'settings-panel',
    ...
    category: 'Recipes',
    order: 6,
    file: 'pages/recipes/settings-panel.md',
    description: 'Comprehensive settings panel with tabs and validation'
  },
  {
    slug: 'accordion',
    title: 'Accordion',
